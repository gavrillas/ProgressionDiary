...
// MARK: - DashboardNavigatorUseCase

open class DashboardNavigatorUseCaseMock: DashboardNavigatorUseCase, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    public typealias MethodStub = Given
    public typealias SubscriptStub = Given
    public typealias DestinationType = DashboardNavigator.NavigationState
    public typealias Destination = EmptyView
    ...
    public var state: DestinationType? {
		get {	invocations.append(.p_state_get); return __p_state ?? optionalGivenGetterValue(.p_state_get, "DashboardNavigatorUseCaseMock - stub value for state was not defined") }
		set {	invocations.append(.p_state_set(.value(newValue))); __p_state = newValue }
	}
	private var __p_state: (DestinationType)?
    ...
    @ViewBuilder
		public var destination: Destination {
		get {	invocations.append(.p_destination_get); return __p_destination ?? givenGetterValue(.p_destination_get, "DashboardNavigatorUseCaseMock - stub value for destination was not defined") }
	}
	private var __p_destination: (Destination)?

    public var models: [DestinationType: Any] {
		get {	invocations.append(.p_models_get); return __p_models ?? givenGetterValue(.p_models_get, "DashboardNavigatorUseCaseMock - stub value for models was not defined") }
		set {	invocations.append(.p_models_set(.value(newValue))); __p_models = newValue }
	}
	private var __p_models: ([DestinationType: Any])?
